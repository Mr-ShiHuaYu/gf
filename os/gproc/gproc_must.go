...
// MustShell performs as Shell, but it panics if interface{} error occurs.
...
// MustShellRun performs as ShellRun, but it panics if interface{} error occurs.
...
// MustShellExec performs as ShellExec, but it panics if interface{} error occurs.
