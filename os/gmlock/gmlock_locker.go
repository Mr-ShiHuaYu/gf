...
import (
	...
	"github.com/Mr-ShiHuaYu/gf/v2/os/gmutex"
)
...
func (l *Locker) getOrNewMutex(key string) *gmutex.RWMutex {
	return l.m.GetOrSetFuncLock(key, func() interface{} {
		return &gmutex.RWMutex{}
	}).(*gmutex.RWMutex)
}
