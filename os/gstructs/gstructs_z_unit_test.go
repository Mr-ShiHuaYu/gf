...
func Test_StructType(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		t.AssertNil(err)
		t.Assert(r.Signature(), `github.com/Mr-ShiHuaYu/gf/v2/os/gstructs_test/gstructs_test.A`)
	})
	gtest.C(t, func(t *gtest.T) {
		type B struct {
			Name string
		...
		t.AssertNil(err)
		t.Assert(r.Signature(), `github.com/Mr-ShiHuaYu/gf/v2/os/gstructs_test/gstructs_test.B`)
	})
	gtest.C(t, func(t *gtest.T) {
		type B struct {
			Name string
