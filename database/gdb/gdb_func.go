...
import (
	...
	"github.com/Mr-ShiHuaYu/gf/v2/util/gmeta"
...
// and returns the quoted string; or else returns `s` without interface{} change.
...
func getFieldsFromStructOrMap(structOrMap interface{}) (fields []interface{}) {
	fields = []interface{}{}
...
type formatWhereKeyValueInput struct {
	...
	Value     interface{}   // The field value, can be interface{} types.
