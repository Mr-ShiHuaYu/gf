...
// It returns the result as a slice of records, the total count of records, and an error if interface{}.
...
func (m *Model) AllAndCount(useFieldForCount bool) (result Result, totalCount int, err error) {
	...
	if !useFieldForCount {
		countModel.fields = []interface{}{Raw("1")}
	}
...
func (m *Model) Array(fieldsAndWhere ...interface{}) (Array, error) {
...
// Note that this function does not change interface{} attribute value of the `m`.
//
// The parameter `limit1` specifies whether limits querying only one record if m.limit is not set.
