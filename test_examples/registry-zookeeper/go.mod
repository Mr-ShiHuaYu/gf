module test-registry-zookeeper

go 1.11

require (
	github.com/Mr-ShiHuaYu/gf/contrib/registry/zookeeper/v2 v2.10.2
	github.com/Mr-ShiHuaYu/gf/v2 v2.9.4
)

replace (
	github.com/BurntSushi/toml => github.com/BurntSushi/toml v0.3.1
	github.com/Mr-ShiHuaYu/gf/contrib/registry/zookeeper/v2 => ../../contrib/registry/zookeeper
