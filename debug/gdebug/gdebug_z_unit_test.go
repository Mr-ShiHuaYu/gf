...
func Test_CallerPackage(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		t.Assert(gdebug.CallerPackage(), "github.com/Mr-ShiHuaYu/gf/v2/test/gtest")
	})
}
...
func Test_FuncPath(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		t.Assert(gdebug.FuncPath(Test_FuncPath), "github.com/Mr-ShiHuaYu/gf/v2/debug/gdebug_test.Test_FuncPath")
	})
}
