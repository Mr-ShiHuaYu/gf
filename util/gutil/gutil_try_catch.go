...
// It returns error if interface{} exception occurs, or else it returns nil.
...
// It automatically calls function `catch` if interface{} exception occurs and passes the exception as an error.
