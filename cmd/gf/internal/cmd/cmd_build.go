...
type cBuildInput struct {
	...
	ExitWhenError bool   `short:"ew" name:"exitWhenError" brief:"exit building when interface{} error occurs, specially for multiple arch and system buildings. default is false" orphan:"true"`
...
func (c cBuild) Index(ctx context.Context, in cBuildInput) (out *cBuildOutput, err error) {
	...
	ldFlags := fmt.Sprintf(
		`-X 'github.com/Mr-ShiHuaYu/gf/v2/os/gbuild.builtInVarStr=%v'`,
